...
public class FormularioController {
    ...
    public String guardarFormulario(
        ...
        // Actualizar el usuario en sesión para que el QR se regenere con datos frescos
        Usuario usuarioActualizado = usuarioService.findById(idUsuario);
        session.setAttribute("usuario", usuarioActualizado);

        redirectAttrs.addFlashAttribute("success", "Datos actualizados correctamente.");
        return "redirect:/dashboard/aprendiz?section=perfil";
    }
}
